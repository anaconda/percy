...
if [[ ! -f aenum-feedstock.mark ]]; then
    if [[ -d aenum-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./aenum-feedstock >d 2>&1 && rm -f d && ( echo "done" >>aenum-feedstock.mark ) && true) || ( (echo "aenum-feedstock" >>failed.24 ) && (echo "aenum-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "aenum-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f apache-airflow-providers-apache-hdfs-feedstock.mark ]]; then
    if [[ -d apache-airflow-providers-apache-hdfs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-airflow-providers-apache-hdfs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-airflow-providers-apache-hdfs-feedstock.mark ) && true) || ( (echo "apache-airflow-providers-apache-hdfs-feedstock" >>failed.24 ) && (echo "apache-airflow-providers-apache-hdfs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-airflow-providers-apache-hdfs-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f argh-feedstock.mark ]]; then
    if [[ -d argh-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./argh-feedstock >d 2>&1 && rm -f d && ( echo "done" >>argh-feedstock.mark ) && true) || ( (echo "argh-feedstock" >>failed.24 ) && (echo "argh-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "argh-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f asyncpgsa-feedstock.mark ]]; then
    if [[ -d asyncpgsa-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./asyncpgsa-feedstock >d 2>&1 && rm -f d && ( echo "done" >>asyncpgsa-feedstock.mark ) && true) || ( (echo "asyncpgsa-feedstock" >>failed.24 ) && (echo "asyncpgsa-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "asyncpgsa-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f backports.os-feedstock.mark ]]; then
    if [[ -d backports.os-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./backports.os-feedstock >d 2>&1 && rm -f d && ( echo "done" >>backports.os-feedstock.mark ) && true) || ( (echo "backports.os-feedstock" >>failed.24 ) && (echo "backports.os-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "backports.os-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f backports.shutil_which-feedstock.mark ]]; then
    if [[ -d backports.shutil_which-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./backports.shutil_which-feedstock >d 2>&1 && rm -f d && ( echo "done" >>backports.shutil_which-feedstock.mark ) && true) || ( (echo "backports.shutil_which-feedstock" >>failed.24 ) && (echo "backports.shutil_which-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "backports.shutil_which-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f billiard-feedstock.mark ]]; then
    if [[ -d billiard-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./billiard-feedstock >d 2>&1 && rm -f d && ( echo "done" >>billiard-feedstock.mark ) && true) || ( (echo "billiard-feedstock" >>failed.24 ) && (echo "billiard-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "billiard-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f bpython-feedstock.mark ]]; then
    if [[ -d bpython-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./bpython-feedstock >d 2>&1 && rm -f d && ( echo "done" >>bpython-feedstock.mark ) && true) || ( (echo "bpython-feedstock" >>failed.24 ) && (echo "bpython-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "bpython-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f capturer-feedstock.mark ]]; then
    if [[ -d capturer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./capturer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>capturer-feedstock.mark ) && true) || ( (echo "capturer-feedstock" >>failed.24 ) && (echo "capturer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "capturer-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f cassandra-driver-feedstock.mark ]]; then
    if [[ -d cassandra-driver-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cassandra-driver-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cassandra-driver-feedstock.mark ) && true) || ( (echo "cassandra-driver-feedstock" >>failed.24 ) && (echo "cassandra-driver-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cassandra-driver-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f chai-feedstock.mark ]]; then
    if [[ -d chai-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./chai-feedstock >d 2>&1 && rm -f d && ( echo "done" >>chai-feedstock.mark ) && true) || ( (echo "chai-feedstock" >>failed.24 ) && (echo "chai-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "chai-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f cherrypy-feedstock.mark ]]; then
    if [[ -d cherrypy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cherrypy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cherrypy-feedstock.mark ) && true) || ( (echo "cherrypy-feedstock" >>failed.24 ) && (echo "cherrypy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cherrypy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f clangdev-feedstock.mark ]]; then
    if [[ -d clangdev-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./clangdev-feedstock >d 2>&1 && rm -f d && ( echo "done" >>clangdev-feedstock.mark ) && true) || ( (echo "clangdev-feedstock" >>failed.24 ) && (echo "clangdev-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "clangdev-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f clickhouse-driver-feedstock.mark ]]; then
    if [[ -d clickhouse-driver-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./clickhouse-driver-feedstock >d 2>&1 && rm -f d && ( echo "done" >>clickhouse-driver-feedstock.mark ) && true) || ( (echo "clickhouse-driver-feedstock" >>failed.24 ) && (echo "clickhouse-driver-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "clickhouse-driver-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f configspace-feedstock.mark ]]; then
    if [[ -d configspace-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./configspace-feedstock >d 2>&1 && rm -f d && ( echo "done" >>configspace-feedstock.mark ) && true) || ( (echo "configspace-feedstock" >>failed.24 ) && (echo "configspace-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "configspace-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f coveralls-feedstock.mark ]]; then
    if [[ -d coveralls-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./coveralls-feedstock >d 2>&1 && rm -f d && ( echo "done" >>coveralls-feedstock.mark ) && true) || ( (echo "coveralls-feedstock" >>failed.24 ) && (echo "coveralls-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "coveralls-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f csvkit-feedstock.mark ]]; then
    if [[ -d csvkit-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./csvkit-feedstock >d 2>&1 && rm -f d && ( echo "done" >>csvkit-feedstock.mark ) && true) || ( (echo "csvkit-feedstock" >>failed.24 ) && (echo "csvkit-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "csvkit-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f cvxopt-feedstock.mark ]]; then
    if [[ -d cvxopt-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cvxopt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cvxopt-feedstock.mark ) && true) || ( (echo "cvxopt-feedstock" >>failed.24 ) && (echo "cvxopt-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cvxopt-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f dask-searchcv-feedstock.mark ]]; then
    if [[ -d dask-searchcv-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dask-searchcv-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dask-searchcv-feedstock.mark ) && true) || ( (echo "dask-searchcv-feedstock" >>failed.24 ) && (echo "dask-searchcv-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dask-searchcv-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f datrie-feedstock.mark ]]; then
    if [[ -d datrie-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./datrie-feedstock >d 2>&1 && rm -f d && ( echo "done" >>datrie-feedstock.mark ) && true) || ( (echo "datrie-feedstock" >>failed.24 ) && (echo "datrie-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "datrie-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f dicttoxml-feedstock.mark ]]; then
    if [[ -d dicttoxml-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dicttoxml-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dicttoxml-feedstock.mark ) && true) || ( (echo "dicttoxml-feedstock" >>failed.24 ) && (echo "dicttoxml-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dicttoxml-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f doit-feedstock.mark ]]; then
    if [[ -d doit-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./doit-feedstock >d 2>&1 && rm -f d && ( echo "done" >>doit-feedstock.mark ) && true) || ( (echo "doit-feedstock" >>failed.24 ) && (echo "doit-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "doit-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f ecos-feedstock.mark ]]; then
    if [[ -d ecos-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ecos-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ecos-feedstock.mark ) && true) || ( (echo "ecos-feedstock" >>failed.24 ) && (echo "ecos-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ecos-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f elasticsearch-async-feedstock.mark ]]; then
    if [[ -d elasticsearch-async-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./elasticsearch-async-feedstock >d 2>&1 && rm -f d && ( echo "done" >>elasticsearch-async-feedstock.mark ) && true) || ( (echo "elasticsearch-async-feedstock" >>failed.24 ) && (echo "elasticsearch-async-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "elasticsearch-async-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f elasticsearch-dsl-feedstock.mark ]]; then
    if [[ -d elasticsearch-dsl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./elasticsearch-dsl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>elasticsearch-dsl-feedstock.mark ) && true) || ( (echo "elasticsearch-dsl-feedstock" >>failed.24 ) && (echo "elasticsearch-dsl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "elasticsearch-dsl-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f enaml-feedstock.mark ]]; then
    if [[ -d enaml-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./enaml-feedstock >d 2>&1 && rm -f d && ( echo "done" >>enaml-feedstock.mark ) && true) || ( (echo "enaml-feedstock" >>failed.24 ) && (echo "enaml-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "enaml-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f enum34-feedstock.mark ]]; then
    if [[ -d enum34-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./enum34-feedstock >d 2>&1 && rm -f d && ( echo "done" >>enum34-feedstock.mark ) && true) || ( (echo "enum34-feedstock" >>failed.24 ) && (echo "enum34-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "enum34-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f ephem-feedstock.mark ]]; then
    if [[ -d ephem-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ephem-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ephem-feedstock.mark ) && true) || ( (echo "ephem-feedstock" >>failed.24 ) && (echo "ephem-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ephem-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f evaluate-feedstock.mark ]]; then
    if [[ -d evaluate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./evaluate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>evaluate-feedstock.mark ) && true) || ( (echo "evaluate-feedstock" >>failed.24 ) && (echo "evaluate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "evaluate-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fabric-feedstock.mark ]]; then
    if [[ -d fabric-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fabric-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fabric-feedstock.mark ) && true) || ( (echo "fabric-feedstock" >>failed.24 ) && (echo "fabric-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fabric-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fabric3-feedstock.mark ]]; then
    if [[ -d fabric3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fabric3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fabric3-feedstock.mark ) && true) || ( (echo "fabric3-feedstock" >>failed.24 ) && (echo "fabric3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fabric3-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f factory_boy-feedstock.mark ]]; then
    if [[ -d factory_boy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./factory_boy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>factory_boy-feedstock.mark ) && true) || ( (echo "factory_boy-feedstock" >>failed.24 ) && (echo "factory_boy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "factory_boy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fastrlock-feedstock.mark ]]; then
    if [[ -d fastrlock-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fastrlock-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fastrlock-feedstock.mark ) && true) || ( (echo "fastrlock-feedstock" >>failed.24 ) && (echo "fastrlock-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fastrlock-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fiona-feedstock.mark ]]; then
    if [[ -d fiona-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fiona-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fiona-feedstock.mark ) && true) || ( (echo "fiona-feedstock" >>failed.24 ) && (echo "fiona-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fiona-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f flake8-import-order-feedstock.mark ]]; then
    if [[ -d flake8-import-order-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./flake8-import-order-feedstock >d 2>&1 && rm -f d && ( echo "done" >>flake8-import-order-feedstock.mark ) && true) || ( (echo "flake8-import-order-feedstock" >>failed.24 ) && (echo "flake8-import-order-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "flake8-import-order-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f funcsigs-feedstock.mark ]]; then
    if [[ -d funcsigs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./funcsigs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>funcsigs-feedstock.mark ) && true) || ( (echo "funcsigs-feedstock" >>failed.24 ) && (echo "funcsigs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "funcsigs-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fuzzywuzzy-feedstock.mark ]]; then
    if [[ -d fuzzywuzzy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fuzzywuzzy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fuzzywuzzy-feedstock.mark ) && true) || ( (echo "fuzzywuzzy-feedstock" >>failed.24 ) && (echo "fuzzywuzzy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fuzzywuzzy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f gensim-feedstock.mark ]]; then
    if [[ -d gensim-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./gensim-feedstock >d 2>&1 && rm -f d && ( echo "done" >>gensim-feedstock.mark ) && true) || ( (echo "gensim-feedstock" >>failed.24 ) && (echo "gensim-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "gensim-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f geventhttpclient-feedstock.mark ]]; then
    if [[ -d geventhttpclient-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./geventhttpclient-feedstock >d 2>&1 && rm -f d && ( echo "done" >>geventhttpclient-feedstock.mark ) && true) || ( (echo "geventhttpclient-feedstock" >>failed.24 ) && (echo "geventhttpclient-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "geventhttpclient-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f glue-vispy-viewers-feedstock.mark ]]; then
    if [[ -d glue-vispy-viewers-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./glue-vispy-viewers-feedstock >d 2>&1 && rm -f d && ( echo "done" >>glue-vispy-viewers-feedstock.mark ) && true) || ( (echo "glue-vispy-viewers-feedstock" >>failed.24 ) && (echo "glue-vispy-viewers-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "glue-vispy-viewers-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f hvplot-feedstock.mark ]]; then
    if [[ -d hvplot-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./hvplot-feedstock >d 2>&1 && rm -f d && ( echo "done" >>hvplot-feedstock.mark ) && true) || ( (echo "hvplot-feedstock" >>failed.24 ) && (echo "hvplot-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "hvplot-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f ibis-framework-feedstock.mark ]]; then
    if [[ -d ibis-framework-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ibis-framework-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ibis-framework-feedstock.mark ) && true) || ( (echo "ibis-framework-feedstock" >>failed.24 ) && (echo "ibis-framework-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ibis-framework-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f idna_ssl-feedstock.mark ]]; then
    if [[ -d idna_ssl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./idna_ssl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>idna_ssl-feedstock.mark ) && true) || ( (echo "idna_ssl-feedstock" >>failed.24 ) && (echo "idna_ssl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "idna_ssl-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f iminuit-feedstock.mark ]]; then
    if [[ -d iminuit-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./iminuit-feedstock >d 2>&1 && rm -f d && ( echo "done" >>iminuit-feedstock.mark ) && true) || ( (echo "iminuit-feedstock" >>failed.24 ) && (echo "iminuit-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "iminuit-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f intake-xarray-feedstock.mark ]]; then
    if [[ -d intake-xarray-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./intake-xarray-feedstock >d 2>&1 && rm -f d && ( echo "done" >>intake-xarray-feedstock.mark ) && true) || ( (echo "intake-xarray-feedstock" >>failed.24 ) && (echo "intake-xarray-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "intake-xarray-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f ipaddr-feedstock.mark ]]; then
    if [[ -d ipaddr-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ipaddr-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ipaddr-feedstock.mark ) && true) || ( (echo "ipaddr-feedstock" >>failed.24 ) && (echo "ipaddr-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ipaddr-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f jaeger-client-feedstock.mark ]]; then
    if [[ -d jaeger-client-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./jaeger-client-feedstock >d 2>&1 && rm -f d && ( echo "done" >>jaeger-client-feedstock.mark ) && true) || ( (echo "jaeger-client-feedstock" >>failed.24 ) && (echo "jaeger-client-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "jaeger-client-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f jsondate-feedstock.mark ]]; then
    if [[ -d jsondate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./jsondate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>jsondate-feedstock.mark ) && true) || ( (echo "jsondate-feedstock" >>failed.24 ) && (echo "jsondate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "jsondate-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f keras-feedstock.mark ]]; then
    if [[ -d keras-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./keras-feedstock >d 2>&1 && rm -f d && ( echo "done" >>keras-feedstock.mark ) && true) || ( (echo "keras-feedstock" >>failed.24 ) && (echo "keras-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "keras-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f keyrings.alt-feedstock.mark ]]; then
    if [[ -d keyrings.alt-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./keyrings.alt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>keyrings.alt-feedstock.mark ) && true) || ( (echo "keyrings.alt-feedstock" >>failed.24 ) && (echo "keyrings.alt-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "keyrings.alt-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f lancet-feedstock.mark ]]; then
    if [[ -d lancet-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./lancet-feedstock >d 2>&1 && rm -f d && ( echo "done" >>lancet-feedstock.mark ) && true) || ( (echo "lancet-feedstock" >>failed.24 ) && (echo "lancet-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "lancet-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f libcst-feedstock.mark ]]; then
    if [[ -d libcst-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./libcst-feedstock >d 2>&1 && rm -f d && ( echo "done" >>libcst-feedstock.mark ) && true) || ( (echo "libcst-feedstock" >>failed.24 ) && (echo "libcst-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "libcst-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f logilab-common-feedstock.mark ]]; then
    if [[ -d logilab-common-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./logilab-common-feedstock >d 2>&1 && rm -f d && ( echo "done" >>logilab-common-feedstock.mark ) && true) || ( (echo "logilab-common-feedstock" >>failed.24 ) && (echo "logilab-common-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "logilab-common-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f luigi-feedstock.mark ]]; then
    if [[ -d luigi-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./luigi-feedstock >d 2>&1 && rm -f d && ( echo "done" >>luigi-feedstock.mark ) && true) || ( (echo "luigi-feedstock" >>failed.24 ) && (echo "luigi-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "luigi-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f moto-feedstock.mark ]]; then
    if [[ -d moto-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./moto-feedstock >d 2>&1 && rm -f d && ( echo "done" >>moto-feedstock.mark ) && true) || ( (echo "moto-feedstock" >>failed.24 ) && (echo "moto-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "moto-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f mpi4py-feedstock.mark ]]; then
    if [[ -d mpi4py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./mpi4py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>mpi4py-feedstock.mark ) && true) || ( (echo "mpi4py-feedstock" >>failed.24 ) && (echo "mpi4py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "mpi4py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f mysqlclient-feedstock.mark ]]; then
    if [[ -d mysqlclient-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./mysqlclient-feedstock >d 2>&1 && rm -f d && ( echo "done" >>mysqlclient-feedstock.mark ) && true) || ( (echo "mysqlclient-feedstock" >>failed.24 ) && (echo "mysqlclient-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "mysqlclient-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f nb_anacondacloud-feedstock.mark ]]; then
    if [[ -d nb_anacondacloud-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_anacondacloud-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_anacondacloud-feedstock.mark ) && true) || ( (echo "nb_anacondacloud-feedstock" >>failed.24 ) && (echo "nb_anacondacloud-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_anacondacloud-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f nb_conda-feedstock.mark ]]; then
    if [[ -d nb_conda-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_conda-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_conda-feedstock.mark ) && true) || ( (echo "nb_conda-feedstock" >>failed.24 ) && (echo "nb_conda-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_conda-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f nbserverproxy-feedstock.mark ]]; then
    if [[ -d nbserverproxy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nbserverproxy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nbserverproxy-feedstock.mark ) && true) || ( (echo "nbserverproxy-feedstock" >>failed.24 ) && (echo "nbserverproxy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nbserverproxy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f neo4j-python-driver-feedstock.mark ]]; then
    if [[ -d neo4j-python-driver-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./neo4j-python-driver-feedstock >d 2>&1 && rm -f d && ( echo "done" >>neo4j-python-driver-feedstock.mark ) && true) || ( (echo "neo4j-python-driver-feedstock" >>failed.24 ) && (echo "neo4j-python-driver-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "neo4j-python-driver-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f netifaces-feedstock.mark ]]; then
    if [[ -d netifaces-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./netifaces-feedstock >d 2>&1 && rm -f d && ( echo "done" >>netifaces-feedstock.mark ) && true) || ( (echo "netifaces-feedstock" >>failed.24 ) && (echo "netifaces-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "netifaces-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f oauthenticator-feedstock.mark ]]; then
    if [[ -d oauthenticator-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./oauthenticator-feedstock >d 2>&1 && rm -f d && ( echo "done" >>oauthenticator-feedstock.mark ) && true) || ( (echo "oauthenticator-feedstock" >>failed.24 ) && (echo "oauthenticator-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "oauthenticator-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f odo-feedstock.mark ]]; then
    if [[ -d odo-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./odo-feedstock >d 2>&1 && rm -f d && ( echo "done" >>odo-feedstock.mark ) && true) || ( (echo "odo-feedstock" >>failed.24 ) && (echo "odo-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "odo-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f onnxruntime-feedstock.mark ]]; then
    if [[ -d onnxruntime-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./onnxruntime-feedstock >d 2>&1 && rm -f d && ( echo "done" >>onnxruntime-feedstock.mark ) && true) || ( (echo "onnxruntime-feedstock" >>failed.24 ) && (echo "onnxruntime-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "onnxruntime-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f opentsne-feedstock.mark ]]; then
    if [[ -d opentsne-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./opentsne-feedstock >d 2>&1 && rm -f d && ( echo "done" >>opentsne-feedstock.mark ) && true) || ( (echo "opentsne-feedstock" >>failed.24 ) && (echo "opentsne-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "opentsne-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f optax-feedstock.mark ]]; then
    if [[ -d optax-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./optax-feedstock >d 2>&1 && rm -f d && ( echo "done" >>optax-feedstock.mark ) && true) || ( (echo "optax-feedstock" >>failed.24 ) && (echo "optax-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "optax-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f orange-widget-base-feedstock.mark ]]; then
    if [[ -d orange-widget-base-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./orange-widget-base-feedstock >d 2>&1 && rm -f d && ( echo "done" >>orange-widget-base-feedstock.mark ) && true) || ( (echo "orange-widget-base-feedstock" >>failed.24 ) && (echo "orange-widget-base-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "orange-widget-base-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f orjson-feedstock.mark ]]; then
    if [[ -d orjson-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./orjson-feedstock >d 2>&1 && rm -f d && ( echo "done" >>orjson-feedstock.mark ) && true) || ( (echo "orjson-feedstock" >>failed.24 ) && (echo "orjson-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "orjson-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pandas-stubs-feedstock.mark ]]; then
    if [[ -d pandas-stubs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pandas-stubs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pandas-stubs-feedstock.mark ) && true) || ( (echo "pandas-stubs-feedstock" >>failed.24 ) && (echo "pandas-stubs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pandas-stubs-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f paste-feedstock.mark ]]; then
    if [[ -d paste-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./paste-feedstock >d 2>&1 && rm -f d && ( echo "done" >>paste-feedstock.mark ) && true) || ( (echo "paste-feedstock" >>failed.24 ) && (echo "paste-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "paste-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pomegranate-feedstock.mark ]]; then
    if [[ -d pomegranate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pomegranate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pomegranate-feedstock.mark ) && true) || ( (echo "pomegranate-feedstock" >>failed.24 ) && (echo "pomegranate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pomegranate-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f progress-feedstock.mark ]]; then
    if [[ -d progress-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./progress-feedstock >d 2>&1 && rm -f d && ( echo "done" >>progress-feedstock.mark ) && true) || ( (echo "progress-feedstock" >>failed.24 ) && (echo "progress-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "progress-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f promise-feedstock.mark ]]; then
    if [[ -d promise-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./promise-feedstock >d 2>&1 && rm -f d && ( echo "done" >>promise-feedstock.mark ) && true) || ( (echo "promise-feedstock" >>failed.24 ) && (echo "promise-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "promise-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyamg-feedstock.mark ]]; then
    if [[ -d pyamg-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyamg-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyamg-feedstock.mark ) && true) || ( (echo "pyamg-feedstock" >>failed.24 ) && (echo "pyamg-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyamg-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyemd-feedstock.mark ]]; then
    if [[ -d pyemd-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyemd-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyemd-feedstock.mark ) && true) || ( (echo "pyemd-feedstock" >>failed.24 ) && (echo "pyemd-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyemd-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pygpu-feedstock.mark ]]; then
    if [[ -d pygpu-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pygpu-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pygpu-feedstock.mark ) && true) || ( (echo "pygpu-feedstock" >>failed.24 ) && (echo "pygpu-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pygpu-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pymongo-feedstock.mark ]]; then
    if [[ -d pymongo-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pymongo-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pymongo-feedstock.mark ) && true) || ( (echo "pymongo-feedstock" >>failed.24 ) && (echo "pymongo-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pymongo-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyquery-feedstock.mark ]]; then
    if [[ -d pyquery-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyquery-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyquery-feedstock.mark ) && true) || ( (echo "pyquery-feedstock" >>failed.24 ) && (echo "pyquery-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyquery-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyspark-feedstock.mark ]]; then
    if [[ -d pyspark-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyspark-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyspark-feedstock.mark ) && true) || ( (echo "pyspark-feedstock" >>failed.24 ) && (echo "pyspark-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyspark-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pytesseract-feedstock.mark ]]; then
    if [[ -d pytesseract-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pytesseract-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pytesseract-feedstock.mark ) && true) || ( (echo "pytesseract-feedstock" >>failed.24 ) && (echo "pytesseract-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pytesseract-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-blosc-feedstock.mark ]]; then
    if [[ -d python-blosc-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-blosc-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-blosc-feedstock.mark ) && true) || ( (echo "python-blosc-feedstock" >>failed.24 ) && (echo "python-blosc-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-blosc-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-gflags-feedstock.mark ]]; then
    if [[ -d python-gflags-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-gflags-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-gflags-feedstock.mark ) && true) || ( (echo "python-gflags-feedstock" >>failed.24 ) && (echo "python-gflags-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-gflags-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-ldap-feedstock.mark ]]; then
    if [[ -d python-ldap-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-ldap-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-ldap-feedstock.mark ) && true) || ( (echo "python-ldap-feedstock" >>failed.24 ) && (echo "python-ldap-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-ldap-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-leveldb-feedstock.mark ]]; then
    if [[ -d python-leveldb-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-leveldb-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-leveldb-feedstock.mark ) && true) || ( (echo "python-leveldb-feedstock" >>failed.24 ) && (echo "python-leveldb-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-leveldb-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-lmdb-feedstock.mark ]]; then
    if [[ -d python-lmdb-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-lmdb-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-lmdb-feedstock.mark ) && true) || ( (echo "python-lmdb-feedstock" >>failed.24 ) && (echo "python-lmdb-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-lmdb-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-memcached-feedstock.mark ]]; then
    if [[ -d python-memcached-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-memcached-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-memcached-feedstock.mark ) && true) || ( (echo "python-memcached-feedstock" >>failed.24 ) && (echo "python-memcached-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-memcached-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-rapidjson-feedstock.mark ]]; then
    if [[ -d python-rapidjson-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-rapidjson-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-rapidjson-feedstock.mark ) && true) || ( (echo "python-rapidjson-feedstock" >>failed.24 ) && (echo "python-rapidjson-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-rapidjson-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pythonnet-feedstock.mark ]]; then
    if [[ -d pythonnet-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pythonnet-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pythonnet-feedstock.mark ) && true) || ( (echo "pythonnet-feedstock" >>failed.24 ) && (echo "pythonnet-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pythonnet-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f qgrid-feedstock.mark ]]; then
    if [[ -d qgrid-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qgrid-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qgrid-feedstock.mark ) && true) || ( (echo "qgrid-feedstock" >>failed.24 ) && (echo "qgrid-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qgrid-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f quandl-feedstock.mark ]]; then
    if [[ -d quandl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./quandl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>quandl-feedstock.mark ) && true) || ( (echo "quandl-feedstock" >>failed.24 ) && (echo "quandl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "quandl-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f rasterio-feedstock.mark ]]; then
    if [[ -d rasterio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./rasterio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>rasterio-feedstock.mark ) && true) || ( (echo "rasterio-feedstock" >>failed.24 ) && (echo "rasterio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "rasterio-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f requests-ftp-feedstock.mark ]]; then
    if [[ -d requests-ftp-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./requests-ftp-feedstock >d 2>&1 && rm -f d && ( echo "done" >>requests-ftp-feedstock.mark ) && true) || ( (echo "requests-ftp-feedstock" >>failed.24 ) && (echo "requests-ftp-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "requests-ftp-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f requests_download-feedstock.mark ]]; then
    if [[ -d requests_download-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./requests_download-feedstock >d 2>&1 && rm -f d && ( echo "done" >>requests_download-feedstock.mark ) && true) || ( (echo "requests_download-feedstock" >>failed.24 ) && (echo "requests_download-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "requests_download-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f rise-feedstock.mark ]]; then
    if [[ -d rise-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./rise-feedstock >d 2>&1 && rm -f d && ( echo "done" >>rise-feedstock.mark ) && true) || ( (echo "rise-feedstock" >>failed.24 ) && (echo "rise-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "rise-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f scikit-bio-feedstock.mark ]]; then
    if [[ -d scikit-bio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-bio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-bio-feedstock.mark ) && true) || ( (echo "scikit-bio-feedstock" >>failed.24 ) && (echo "scikit-bio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-bio-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f scikit-learn-intelex-feedstock.mark ]]; then
    if [[ -d scikit-learn-intelex-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-learn-intelex-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-learn-intelex-feedstock.mark ) && true) || ( (echo "scikit-learn-intelex-feedstock" >>failed.24 ) && (echo "scikit-learn-intelex-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-learn-intelex-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f scrapy-feedstock.mark ]]; then
    if [[ -d scrapy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scrapy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scrapy-feedstock.mark ) && true) || ( (echo "scrapy-feedstock" >>failed.24 ) && (echo "scrapy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scrapy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f selenium-feedstock.mark ]]; then
    if [[ -d selenium-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./selenium-feedstock >d 2>&1 && rm -f d && ( echo "done" >>selenium-feedstock.mark ) && true) || ( (echo "selenium-feedstock" >>failed.24 ) && (echo "selenium-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "selenium-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sentencepiece-feedstock.mark ]]; then
    if [[ -d sentencepiece-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sentencepiece-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sentencepiece-feedstock.mark ) && true) || ( (echo "sentencepiece-feedstock" >>failed.24 ) && (echo "sentencepiece-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sentencepiece-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f serverfiles-feedstock.mark ]]; then
    if [[ -d serverfiles-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./serverfiles-feedstock >d 2>&1 && rm -f d && ( echo "done" >>serverfiles-feedstock.mark ) && true) || ( (echo "serverfiles-feedstock" >>failed.24 ) && (echo "serverfiles-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "serverfiles-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sh-feedstock.mark ]]; then
    if [[ -d sh-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sh-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sh-feedstock.mark ) && true) || ( (echo "sh-feedstock" >>failed.24 ) && (echo "sh-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sh-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f slackclient-feedstock.mark ]]; then
    if [[ -d slackclient-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./slackclient-feedstock >d 2>&1 && rm -f d && ( echo "done" >>slackclient-feedstock.mark ) && true) || ( (echo "slackclient-feedstock" >>failed.24 ) && (echo "slackclient-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "slackclient-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f snowflake-connector-python-feedstock.mark ]]; then
    if [[ -d snowflake-connector-python-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./snowflake-connector-python-feedstock >d 2>&1 && rm -f d && ( echo "done" >>snowflake-connector-python-feedstock.mark ) && true) || ( (echo "snowflake-connector-python-feedstock" >>failed.24 ) && (echo "snowflake-connector-python-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "snowflake-connector-python-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f spacy-feedstock.mark ]]; then
    if [[ -d spacy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./spacy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>spacy-feedstock.mark ) && true) || ( (echo "spacy-feedstock" >>failed.24 ) && (echo "spacy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "spacy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sputnik-feedstock.mark ]]; then
    if [[ -d sputnik-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sputnik-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sputnik-feedstock.mark ) && true) || ( (echo "sputnik-feedstock" >>failed.24 ) && (echo "sputnik-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sputnik-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f spyder-feedstock.mark ]]; then
    if [[ -d spyder-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./spyder-feedstock >d 2>&1 && rm -f d && ( echo "done" >>spyder-feedstock.mark ) && true) || ( (echo "spyder-feedstock" >>failed.24 ) && (echo "spyder-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "spyder-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f streamlit-feedstock.mark ]]; then
    if [[ -d streamlit-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./streamlit-feedstock >d 2>&1 && rm -f d && ( echo "done" >>streamlit-feedstock.mark ) && true) || ( (echo "streamlit-feedstock" >>failed.24 ) && (echo "streamlit-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "streamlit-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f supervisor-feedstock.mark ]]; then
    if [[ -d supervisor-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./supervisor-feedstock >d 2>&1 && rm -f d && ( echo "done" >>supervisor-feedstock.mark ) && true) || ( (echo "supervisor-feedstock" >>failed.24 ) && (echo "supervisor-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "supervisor-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f tabula-py-feedstock.mark ]]; then
    if [[ -d tabula-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./tabula-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>tabula-py-feedstock.mark ) && true) || ( (echo "tabula-py-feedstock" >>failed.24 ) && (echo "tabula-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "tabula-py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f testtools-feedstock.mark ]]; then
    if [[ -d testtools-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./testtools-feedstock >d 2>&1 && rm -f d && ( echo "done" >>testtools-feedstock.mark ) && true) || ( (echo "testtools-feedstock" >>failed.24 ) && (echo "testtools-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "testtools-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f thefuzz-feedstock.mark ]]; then
    if [[ -d thefuzz-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./thefuzz-feedstock >d 2>&1 && rm -f d && ( echo "done" >>thefuzz-feedstock.mark ) && true) || ( (echo "thefuzz-feedstock" >>failed.24 ) && (echo "thefuzz-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "thefuzz-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f twofish-feedstock.mark ]]; then
    if [[ -d twofish-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./twofish-feedstock >d 2>&1 && rm -f d && ( echo "done" >>twofish-feedstock.mark ) && true) || ( (echo "twofish-feedstock" >>failed.24 ) && (echo "twofish-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "twofish-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f twython-feedstock.mark ]]; then
    if [[ -d twython-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./twython-feedstock/ >d 2>&1 && rm -f d && ( echo "done" >>twython-feedstock.mark ) && true) || ( (echo "twython-feedstock" >>failed.24 ) && (echo "twython-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "twython-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f vcrpy-feedstock.mark ]]; then
    if [[ -d vcrpy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./vcrpy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>vcrpy-feedstock.mark ) && true) || ( (echo "vcrpy-feedstock" >>failed.24 ) && (echo "vcrpy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "vcrpy-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f vcversioner-feedstock.mark ]]; then
    if [[ -d vcversioner-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./vcversioner-feedstock >d 2>&1 && rm -f d && ( echo "done" >>vcversioner-feedstock.mark ) && true) || ( (echo "vcversioner-feedstock" >>failed.24 ) && (echo "vcversioner-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "vcversioner-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f verboselogs-feedstock.mark ]]; then
    if [[ -d verboselogs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./verboselogs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>verboselogs-feedstock.mark ) && true) || ( (echo "verboselogs-feedstock" >>failed.24 ) && (echo "verboselogs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "verboselogs-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f ws4py-feedstock.mark ]]; then
    if [[ -d ws4py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ws4py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ws4py-feedstock.mark ) && true) || ( (echo "ws4py-feedstock" >>failed.24 ) && (echo "ws4py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ws4py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f xcb-proto-feedstock.mark ]]; then
    if [[ -d xcb-proto-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./xcb-proto-feedstock >d 2>&1 && rm -f d && ( echo "done" >>xcb-proto-feedstock.mark ) && true) || ( (echo "xcb-proto-feedstock" >>failed.24 ) && (echo "xcb-proto-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "xcb-proto-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f xlwings-feedstock.mark ]]; then
    if [[ -d xlwings-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./xlwings-feedstock >d 2>&1 && rm -f d && ( echo "done" >>xlwings-feedstock.mark ) && true) || ( (echo "xlwings-feedstock" >>failed.24 ) && (echo "xlwings-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "xlwings-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f yt-feedstock.mark ]]; then
    if [[ -d yt-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./yt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>yt-feedstock.mark ) && true) || ( (echo "yt-feedstock" >>failed.24 ) && (echo "yt-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "yt-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f zeep-feedstock.mark ]]; then
    if [[ -d zeep-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./zeep-feedstock >d 2>&1 && rm -f d && ( echo "done" >>zeep-feedstock.mark ) && true) || ( (echo "zeep-feedstock" >>failed.24 ) && (echo "zeep-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "zeep-feedstock not present" >>failed.24
    fi
fi
