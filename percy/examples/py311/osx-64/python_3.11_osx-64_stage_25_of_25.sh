...
if [[ ! -f apache-airflow-providers-apache-hdfs-feedstock.mark ]]; then
    if [[ -d apache-airflow-providers-apache-hdfs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-airflow-providers-apache-hdfs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-airflow-providers-apache-hdfs-feedstock.mark ) && true) || ( (echo "apache-airflow-providers-apache-hdfs-feedstock" >>failed.25 ) && (echo "apache-airflow-providers-apache-hdfs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-airflow-providers-apache-hdfs-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f comm-feedstock.mark ]]; then
    if [[ -d comm-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./comm-feedstock >d 2>&1 && rm -f d && ( echo "done" >>comm-feedstock.mark ) && true) || ( (echo "comm-feedstock" >>failed.25 ) && (echo "comm-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "comm-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f constructor-feedstock.mark ]]; then
    if [[ -d constructor-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./constructor-feedstock >d 2>&1 && rm -f d && ( echo "done" >>constructor-feedstock.mark ) && true) || ( (echo "constructor-feedstock" >>failed.25 ) && (echo "constructor-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "constructor-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f dash-feedstock.mark ]]; then
    if [[ -d dash-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dash-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dash-feedstock.mark ) && true) || ( (echo "dash-feedstock" >>failed.25 ) && (echo "dash-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dash-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f dask-searchcv-feedstock.mark ]]; then
    if [[ -d dask-searchcv-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dask-searchcv-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dask-searchcv-feedstock.mark ) && true) || ( (echo "dask-searchcv-feedstock" >>failed.25 ) && (echo "dask-searchcv-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dask-searchcv-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f docstring-to-markdown-feedstock.mark ]]; then
    if [[ -d docstring-to-markdown-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./docstring-to-markdown-feedstock >d 2>&1 && rm -f d && ( echo "done" >>docstring-to-markdown-feedstock.mark ) && true) || ( (echo "docstring-to-markdown-feedstock" >>failed.25 ) && (echo "docstring-to-markdown-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "docstring-to-markdown-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f drmaa-feedstock.mark ]]; then
    if [[ -d drmaa-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./drmaa-feedstock >d 2>&1 && rm -f d && ( echo "done" >>drmaa-feedstock.mark ) && true) || ( (echo "drmaa-feedstock" >>failed.25 ) && (echo "drmaa-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "drmaa-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f elasticsearch-async-feedstock.mark ]]; then
    if [[ -d elasticsearch-async-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./elasticsearch-async-feedstock >d 2>&1 && rm -f d && ( echo "done" >>elasticsearch-async-feedstock.mark ) && true) || ( (echo "elasticsearch-async-feedstock" >>failed.25 ) && (echo "elasticsearch-async-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "elasticsearch-async-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f fabric3-feedstock.mark ]]; then
    if [[ -d fabric3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fabric3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>fabric3-feedstock.mark ) && true) || ( (echo "fabric3-feedstock" >>failed.25 ) && (echo "fabric3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fabric3-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f geoviews-core-feedstock.mark ]]; then
    if [[ -d geoviews-core-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./geoviews-core-feedstock >d 2>&1 && rm -f d && ( echo "done" >>geoviews-core-feedstock.mark ) && true) || ( (echo "geoviews-core-feedstock" >>failed.25 ) && (echo "geoviews-core-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "geoviews-core-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f ibis-framework-feedstock.mark ]]; then
    if [[ -d ibis-framework-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ibis-framework-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ibis-framework-feedstock.mark ) && true) || ( (echo "ibis-framework-feedstock" >>failed.25 ) && (echo "ibis-framework-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ibis-framework-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f keras-feedstock.mark ]]; then
    if [[ -d keras-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./keras-feedstock >d 2>&1 && rm -f d && ( echo "done" >>keras-feedstock.mark ) && true) || ( (echo "keras-feedstock" >>failed.25 ) && (echo "keras-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "keras-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f matrixprofile-feedstock.mark ]]; then
    if [[ -d matrixprofile-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./matrixprofile-feedstock >d 2>&1 && rm -f d && ( echo "done" >>matrixprofile-feedstock.mark ) && true) || ( (echo "matrixprofile-feedstock" >>failed.25 ) && (echo "matrixprofile-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "matrixprofile-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f odo-feedstock.mark ]]; then
    if [[ -d odo-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./odo-feedstock >d 2>&1 && rm -f d && ( echo "done" >>odo-feedstock.mark ) && true) || ( (echo "odo-feedstock" >>failed.25 ) && (echo "odo-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "odo-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f onnxmltools-feedstock.mark ]]; then
    if [[ -d onnxmltools-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./onnxmltools-feedstock >d 2>&1 && rm -f d && ( echo "done" >>onnxmltools-feedstock.mark ) && true) || ( (echo "onnxmltools-feedstock" >>failed.25 ) && (echo "onnxmltools-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "onnxmltools-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f onnxruntime-feedstock.mark ]]; then
    if [[ -d onnxruntime-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./onnxruntime-feedstock >d 2>&1 && rm -f d && ( echo "done" >>onnxruntime-feedstock.mark ) && true) || ( (echo "onnxruntime-feedstock" >>failed.25 ) && (echo "onnxruntime-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "onnxruntime-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pmdarima-feedstock.mark ]]; then
    if [[ -d pmdarima-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pmdarima-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pmdarima-feedstock.mark ) && true) || ( (echo "pmdarima-feedstock" >>failed.25 ) && (echo "pmdarima-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pmdarima-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pomegranate-feedstock.mark ]]; then
    if [[ -d pomegranate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pomegranate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pomegranate-feedstock.mark ) && true) || ( (echo "pomegranate-feedstock" >>failed.25 ) && (echo "pomegranate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pomegranate-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f progressbar2-feedstock.mark ]]; then
    if [[ -d progressbar2-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./progressbar2-feedstock >d 2>&1 && rm -f d && ( echo "done" >>progressbar2-feedstock.mark ) && true) || ( (echo "progressbar2-feedstock" >>failed.25 ) && (echo "progressbar2-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "progressbar2-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pycrypto-feedstock.mark ]]; then
    if [[ -d pycrypto-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pycrypto-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pycrypto-feedstock.mark ) && true) || ( (echo "pycrypto-feedstock" >>failed.25 ) && (echo "pycrypto-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pycrypto-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pylint-venv-feedstock.mark ]]; then
    if [[ -d pylint-venv-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pylint-venv-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pylint-venv-feedstock.mark ) && true) || ( (echo "pylint-venv-feedstock" >>failed.25 ) && (echo "pylint-venv-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pylint-venv-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pymc3-feedstock.mark ]]; then
    if [[ -d pymc3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pymc3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pymc3-feedstock.mark ) && true) || ( (echo "pymc3-feedstock" >>failed.25 ) && (echo "pymc3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pymc3-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pytoolconfig-feedstock.mark ]]; then
    if [[ -d pytoolconfig-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pytoolconfig-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pytoolconfig-feedstock.mark ) && true) || ( (echo "pytoolconfig-feedstock" >>failed.25 ) && (echo "pytoolconfig-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pytoolconfig-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f runipy-feedstock.mark ]]; then
    if [[ -d runipy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./runipy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>runipy-feedstock.mark ) && true) || ( (echo "runipy-feedstock" >>failed.25 ) && (echo "runipy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "runipy-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f scikit-bio-feedstock.mark ]]; then
    if [[ -d scikit-bio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-bio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-bio-feedstock.mark ) && true) || ( (echo "scikit-bio-feedstock" >>failed.25 ) && (echo "scikit-bio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-bio-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f smartypants-feedstock.mark ]]; then
    if [[ -d smartypants-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./smartypants-feedstock >d 2>&1 && rm -f d && ( echo "done" >>smartypants-feedstock.mark ) && true) || ( (echo "smartypants-feedstock" >>failed.25 ) && (echo "smartypants-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "smartypants-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f snowflake-connector-python-feedstock.mark ]]; then
    if [[ -d snowflake-connector-python-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./snowflake-connector-python-feedstock >d 2>&1 && rm -f d && ( echo "done" >>snowflake-connector-python-feedstock.mark ) && true) || ( (echo "snowflake-connector-python-feedstock" >>failed.25 ) && (echo "snowflake-connector-python-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "snowflake-connector-python-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f thrift_sasl-feedstock.mark ]]; then
    if [[ -d thrift_sasl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./thrift_sasl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>thrift_sasl-feedstock.mark ) && true) || ( (echo "thrift_sasl-feedstock" >>failed.25 ) && (echo "thrift_sasl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "thrift_sasl-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f thriftpy2-feedstock.mark ]]; then
    if [[ -d thriftpy2-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./thriftpy2-feedstock >d 2>&1 && rm -f d && ( echo "done" >>thriftpy2-feedstock.mark ) && true) || ( (echo "thriftpy2-feedstock" >>failed.25 ) && (echo "thriftpy2-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "thriftpy2-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f transaction-feedstock.mark ]]; then
    if [[ -d transaction-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./transaction-feedstock >d 2>&1 && rm -f d && ( echo "done" >>transaction-feedstock.mark ) && true) || ( (echo "transaction-feedstock" >>failed.25 ) && (echo "transaction-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "transaction-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f xcb-proto-feedstock.mark ]]; then
    if [[ -d xcb-proto-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./xcb-proto-feedstock >d 2>&1 && rm -f d && ( echo "done" >>xcb-proto-feedstock.mark ) && true) || ( (echo "xcb-proto-feedstock" >>failed.25 ) && (echo "xcb-proto-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "xcb-proto-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f xlwings-feedstock.mark ]]; then
    if [[ -d xlwings-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./xlwings-feedstock >d 2>&1 && rm -f d && ( echo "done" >>xlwings-feedstock.mark ) && true) || ( (echo "xlwings-feedstock" >>failed.25 ) && (echo "xlwings-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "xlwings-feedstock not present" >>failed.25
    fi
fi
