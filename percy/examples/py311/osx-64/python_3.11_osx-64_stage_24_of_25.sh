...
if [[ ! -f daal4py-feedstock.mark ]]; then
    if [[ -d daal4py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./daal4py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>daal4py-feedstock.mark ) && true) || ( (echo "daal4py-feedstock" >>failed.24 ) && (echo "daal4py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "daal4py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f gdal-py-feedstock.mark ]]; then
    if [[ -d gdal-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./gdal-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>gdal-py-feedstock.mark ) && true) || ( (echo "gdal-py-feedstock" >>failed.24 ) && (echo "gdal-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "gdal-py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f mkl-service-feedstock.mark ]]; then
    if [[ -d mkl-service-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./mkl-service-feedstock >d 2>&1 && rm -f d && ( echo "done" >>mkl-service-feedstock.mark ) && true) || ( (echo "mkl-service-feedstock" >>failed.24 ) && (echo "mkl-service-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "mkl-service-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pdm-feedstock.mark ]]; then
    if [[ -d pdm-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pdm-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pdm-feedstock.mark ) && true) || ( (echo "pdm-feedstock" >>failed.24 ) && (echo "pdm-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pdm-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pymysql-feedstock.mark ]]; then
    if [[ -d pymysql-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pymysql-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pymysql-feedstock.mark ) && true) || ( (echo "pymysql-feedstock" >>failed.24 ) && (echo "pymysql-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pymysql-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sasl-feedstock.mark ]]; then
    if [[ -d sasl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sasl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sasl-feedstock.mark ) && true) || ( (echo "sasl-feedstock" >>failed.24 ) && (echo "sasl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sasl-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f skl2onnx-feedstock.mark ]]; then
    if [[ -d skl2onnx-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./skl2onnx-feedstock >d 2>&1 && rm -f d && ( echo "done" >>skl2onnx-feedstock.mark ) && true) || ( (echo "skl2onnx-feedstock" >>failed.24 ) && (echo "skl2onnx-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "skl2onnx-feedstock not present" >>failed.24
    fi
fi
