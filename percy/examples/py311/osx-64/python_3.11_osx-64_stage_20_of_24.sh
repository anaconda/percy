...
if [[ ! -f matplotlib-feedstock.mark ]]; then
    if [[ -d matplotlib-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./matplotlib-feedstock >d 2>&1 && rm -f d && ( echo "done" >>matplotlib-feedstock.mark ) && true) || ( (echo "matplotlib-feedstock" >>failed.20 ) && (echo "matplotlib-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "matplotlib-feedstock not present" >>failed.20
    fi
fi
...
if [[ ! -f pyobjc-framework-cocoa-feedstock.mark ]]; then
    if [[ -d pyobjc-framework-cocoa-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyobjc-framework-cocoa-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyobjc-framework-cocoa-feedstock.mark ) && true) || ( (echo "pyobjc-framework-cocoa-feedstock" >>failed.20 ) && (echo "pyobjc-framework-cocoa-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyobjc-framework-cocoa-feedstock not present" >>failed.20
    fi
fi
...
if [[ ! -f qtconsole-feedstock.mark ]]; then
    if [[ -d qtconsole-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qtconsole-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qtconsole-feedstock.mark ) && true) || ( (echo "qtconsole-feedstock" >>failed.20 ) && (echo "qtconsole-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qtconsole-feedstock not present" >>failed.20
    fi
fi
...
if [[ ! -f twine-feedstock.mark ]]; then
    if [[ -d twine-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./twine-feedstock >d 2>&1 && rm -f d && ( echo "done" >>twine-feedstock.mark ) && true) || ( (echo "twine-feedstock" >>failed.20 ) && (echo "twine-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "twine-feedstock not present" >>failed.20
    fi
fi
