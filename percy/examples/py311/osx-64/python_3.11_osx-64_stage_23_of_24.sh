...
if [[ ! -f appscript-feedstock.mark ]]; then
    if [[ -d appscript-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./appscript-feedstock >d 2>&1 && rm -f d && ( echo "done" >>appscript-feedstock.mark ) && true) || ( (echo "appscript-feedstock" >>failed.23 ) && (echo "appscript-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "appscript-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f basemap-feedstock.mark ]]; then
    if [[ -d basemap-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./basemap-feedstock >d 2>&1 && rm -f d && ( echo "done" >>basemap-feedstock.mark ) && true) || ( (echo "basemap-feedstock" >>failed.23 ) && (echo "basemap-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "basemap-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f cartopy-feedstock.mark ]]; then
    if [[ -d cartopy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cartopy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cartopy-feedstock.mark ) && true) || ( (echo "cartopy-feedstock" >>failed.23 ) && (echo "cartopy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cartopy-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f cfn-lint-feedstock.mark ]]; then
    if [[ -d cfn-lint-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cfn-lint-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cfn-lint-feedstock.mark ) && true) || ( (echo "cfn-lint-feedstock" >>failed.23 ) && (echo "cfn-lint-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cfn-lint-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f chex-feedstock.mark ]]; then
    if [[ -d chex-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./chex-feedstock >d 2>&1 && rm -f d && ( echo "done" >>chex-feedstock.mark ) && true) || ( (echo "chex-feedstock" >>failed.23 ) && (echo "chex-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "chex-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f clr_loader-feedstock.mark ]]; then
    if [[ -d clr_loader-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./clr_loader-feedstock >d 2>&1 && rm -f d && ( echo "done" >>clr_loader-feedstock.mark ) && true) || ( (echo "clr_loader-feedstock" >>failed.23 ) && (echo "clr_loader-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "clr_loader-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f curtsies-feedstock.mark ]]; then
    if [[ -d curtsies-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./curtsies-feedstock >d 2>&1 && rm -f d && ( echo "done" >>curtsies-feedstock.mark ) && true) || ( (echo "curtsies-feedstock" >>failed.23 ) && (echo "curtsies-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "curtsies-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f daal4py-feedstock.mark ]]; then
    if [[ -d daal4py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./daal4py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>daal4py-feedstock.mark ) && true) || ( (echo "daal4py-feedstock" >>failed.23 ) && (echo "daal4py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "daal4py-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f datasets-feedstock.mark ]]; then
    if [[ -d datasets-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./datasets-feedstock >d 2>&1 && rm -f d && ( echo "done" >>datasets-feedstock.mark ) && true) || ( (echo "datasets-feedstock" >>failed.23 ) && (echo "datasets-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "datasets-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f datashape-feedstock.mark ]]; then
    if [[ -d datashape-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./datashape-feedstock >d 2>&1 && rm -f d && ( echo "done" >>datashape-feedstock.mark ) && true) || ( (echo "datashape-feedstock" >>failed.23 ) && (echo "datashape-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "datashape-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f docker-py-feedstock.mark ]]; then
    if [[ -d docker-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./docker-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>docker-py-feedstock.mark ) && true) || ( (echo "docker-py-feedstock" >>failed.23 ) && (echo "docker-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "docker-py-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f gdal-py-feedstock.mark ]]; then
    if [[ -d gdal-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./gdal-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>gdal-py-feedstock.mark ) && true) || ( (echo "gdal-py-feedstock" >>failed.23 ) && (echo "gdal-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "gdal-py-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f glue-core-feedstock.mark ]]; then
    if [[ -d glue-core-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./glue-core-feedstock >d 2>&1 && rm -f d && ( echo "done" >>glue-core-feedstock.mark ) && true) || ( (echo "glue-core-feedstock" >>failed.23 ) && (echo "glue-core-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "glue-core-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f holoviews-feedstock.mark ]]; then
    if [[ -d holoviews-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./holoviews-feedstock >d 2>&1 && rm -f d && ( echo "done" >>holoviews-feedstock.mark ) && true) || ( (echo "holoviews-feedstock" >>failed.23 ) && (echo "holoviews-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "holoviews-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f impyla-feedstock.mark ]]; then
    if [[ -d impyla-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./impyla-feedstock >d 2>&1 && rm -f d && ( echo "done" >>impyla-feedstock.mark ) && true) || ( (echo "impyla-feedstock" >>failed.23 ) && (echo "impyla-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "impyla-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f intake-feedstock.mark ]]; then
    if [[ -d intake-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./intake-feedstock >d 2>&1 && rm -f d && ( echo "done" >>intake-feedstock.mark ) && true) || ( (echo "intake-feedstock" >>failed.23 ) && (echo "intake-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "intake-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f invoke-feedstock.mark ]]; then
    if [[ -d invoke-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./invoke-feedstock >d 2>&1 && rm -f d && ( echo "done" >>invoke-feedstock.mark ) && true) || ( (echo "invoke-feedstock" >>failed.23 ) && (echo "invoke-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "invoke-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f macfsevents-feedstock.mark ]]; then
    if [[ -d macfsevents-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./macfsevents-feedstock >d 2>&1 && rm -f d && ( echo "done" >>macfsevents-feedstock.mark ) && true) || ( (echo "macfsevents-feedstock" >>failed.23 ) && (echo "macfsevents-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "macfsevents-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f maturin-feedstock.mark ]]; then
    if [[ -d maturin-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./maturin-feedstock >d 2>&1 && rm -f d && ( echo "done" >>maturin-feedstock.mark ) && true) || ( (echo "maturin-feedstock" >>failed.23 ) && (echo "maturin-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "maturin-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f mkl-service-feedstock.mark ]]; then
    if [[ -d mkl-service-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./mkl-service-feedstock >d 2>&1 && rm -f d && ( echo "done" >>mkl-service-feedstock.mark ) && true) || ( (echo "mkl-service-feedstock" >>failed.23 ) && (echo "mkl-service-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "mkl-service-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f nb_conda_kernels-feedstock.mark ]]; then
    if [[ -d nb_conda_kernels-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_conda_kernels-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_conda_kernels-feedstock.mark ) && true) || ( (echo "nb_conda_kernels-feedstock" >>failed.23 ) && (echo "nb_conda_kernels-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_conda_kernels-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f opentracing-feedstock.mark ]]; then
    if [[ -d opentracing-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./opentracing-feedstock >d 2>&1 && rm -f d && ( echo "done" >>opentracing-feedstock.mark ) && true) || ( (echo "opentracing-feedstock" >>failed.23 ) && (echo "opentracing-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "opentracing-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f orange-canvas-core-feedstock.mark ]]; then
    if [[ -d orange-canvas-core-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./orange-canvas-core-feedstock >d 2>&1 && rm -f d && ( echo "done" >>orange-canvas-core-feedstock.mark ) && true) || ( (echo "orange-canvas-core-feedstock" >>failed.23 ) && (echo "orange-canvas-core-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "orange-canvas-core-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f pathy-feedstock.mark ]]; then
    if [[ -d pathy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pathy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pathy-feedstock.mark ) && true) || ( (echo "pathy-feedstock" >>failed.23 ) && (echo "pathy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pathy-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f pymysql-feedstock.mark ]]; then
    if [[ -d pymysql-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pymysql-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pymysql-feedstock.mark ) && true) || ( (echo "pymysql-feedstock" >>failed.23 ) && (echo "pymysql-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pymysql-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f pyopengl-feedstock.mark ]]; then
    if [[ -d pyopengl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyopengl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyopengl-feedstock.mark ) && true) || ( (echo "pyopengl-feedstock" >>failed.23 ) && (echo "pyopengl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyopengl-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f pyqtgraph-feedstock.mark ]]; then
    if [[ -d pyqtgraph-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyqtgraph-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyqtgraph-feedstock.mark ) && true) || ( (echo "pyqtgraph-feedstock" >>failed.23 ) && (echo "pyqtgraph-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyqtgraph-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f python-levenshtein-feedstock.mark ]]; then
    if [[ -d python-levenshtein-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-levenshtein-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-levenshtein-feedstock.mark ) && true) || ( (echo "python-levenshtein-feedstock" >>failed.23 ) && (echo "python-levenshtein-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-levenshtein-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f qstylizer-feedstock.mark ]]; then
    if [[ -d qstylizer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qstylizer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qstylizer-feedstock.mark ) && true) || ( (echo "qstylizer-feedstock" >>failed.23 ) && (echo "qstylizer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qstylizer-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f qtawesome-feedstock.mark ]]; then
    if [[ -d qtawesome-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qtawesome-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qtawesome-feedstock.mark ) && true) || ( (echo "qtawesome-feedstock" >>failed.23 ) && (echo "qtawesome-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qtawesome-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f rtree-feedstock.mark ]]; then
    if [[ -d rtree-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./rtree-feedstock >d 2>&1 && rm -f d && ( echo "done" >>rtree-feedstock.mark ) && true) || ( (echo "rtree-feedstock" >>failed.23 ) && (echo "rtree-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "rtree-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f thinc-feedstock.mark ]]; then
    if [[ -d thinc-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./thinc-feedstock >d 2>&1 && rm -f d && ( echo "done" >>thinc-feedstock.mark ) && true) || ( (echo "thinc-feedstock" >>failed.23 ) && (echo "thinc-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "thinc-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f types-pytz-feedstock.mark ]]; then
    if [[ -d types-pytz-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./types-pytz-feedstock >d 2>&1 && rm -f d && ( echo "done" >>types-pytz-feedstock.mark ) && true) || ( (echo "types-pytz-feedstock" >>failed.23 ) && (echo "types-pytz-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "types-pytz-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f urwid-feedstock.mark ]]; then
    if [[ -d urwid-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./urwid-feedstock >d 2>&1 && rm -f d && ( echo "done" >>urwid-feedstock.mark ) && true) || ( (echo "urwid-feedstock" >>failed.23 ) && (echo "urwid-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "urwid-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f vispy-feedstock.mark ]]; then
    if [[ -d vispy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./vispy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>vispy-feedstock.mark ) && true) || ( (echo "vispy-feedstock" >>failed.23 ) && (echo "vispy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "vispy-feedstock not present" >>failed.23
    fi
fi
...
if [[ ! -f zarr-feedstock.mark ]]; then
    if [[ -d zarr-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./zarr-feedstock >d 2>&1 && rm -f d && ( echo "done" >>zarr-feedstock.mark ) && true) || ( (echo "zarr-feedstock" >>failed.23 ) && (echo "zarr-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "zarr-feedstock not present" >>failed.23
    fi
fi
