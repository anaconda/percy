...
if [[ ! -f absl-py-feedstock.mark ]]; then
    if [[ -d absl-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./absl-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>absl-py-feedstock.mark ) && true) || ( (echo "absl-py-feedstock" >>failed.22 ) && (echo "absl-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "absl-py-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f anyqt-feedstock.mark ]]; then
    if [[ -d anyqt-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./anyqt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>anyqt-feedstock.mark ) && true) || ( (echo "anyqt-feedstock" >>failed.22 ) && (echo "anyqt-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "anyqt-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f astropy-feedstock.mark ]]; then
    if [[ -d astropy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./astropy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>astropy-feedstock.mark ) && true) || ( (echo "astropy-feedstock" >>failed.22 ) && (echo "astropy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "astropy-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f dm-tree-feedstock.mark ]]; then
    if [[ -d dm-tree-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dm-tree-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dm-tree-feedstock.mark ) && true) || ( (echo "dm-tree-feedstock" >>failed.22 ) && (echo "dm-tree-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dm-tree-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f h5py-feedstock.mark ]]; then
    if [[ -d h5py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./h5py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>h5py-feedstock.mark ) && true) || ( (echo "h5py-feedstock" >>failed.22 ) && (echo "h5py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "h5py-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f hsluv-feedstock.mark ]]; then
    if [[ -d hsluv-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./hsluv-feedstock >d 2>&1 && rm -f d && ( echo "done" >>hsluv-feedstock.mark ) && true) || ( (echo "hsluv-feedstock" >>failed.22 ) && (echo "hsluv-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "hsluv-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f jax-feedstock.mark ]]; then
    if [[ -d jax-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./jax-feedstock >d 2>&1 && rm -f d && ( echo "done" >>jax-feedstock.mark ) && true) || ( (echo "jax-feedstock" >>failed.22 ) && (echo "jax-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "jax-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f pyobjc-framework-coreservices-feedstock.mark ]]; then
    if [[ -d pyobjc-framework-coreservices-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyobjc-framework-coreservices-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyobjc-framework-coreservices-feedstock.mark ) && true) || ( (echo "pyobjc-framework-coreservices-feedstock" >>failed.22 ) && (echo "pyobjc-framework-coreservices-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyobjc-framework-coreservices-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f python.app-feedstock.mark ]]; then
    if [[ -d python.app-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python.app-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python.app-feedstock.mark ) && true) || ( (echo "python.app-feedstock" >>failed.22 ) && (echo "python.app-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python.app-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f qasync-feedstock.mark ]]; then
    if [[ -d qasync-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qasync-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qasync-feedstock.mark ) && true) || ( (echo "qasync-feedstock" >>failed.22 ) && (echo "qasync-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qasync-feedstock not present" >>failed.22
    fi
fi
...
if [[ ! -f scikit-image-feedstock.mark ]]; then
    if [[ -d scikit-image-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-image-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-image-feedstock.mark ) && true) || ( (echo "scikit-image-feedstock" >>failed.22 ) && (echo "scikit-image-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-image-feedstock not present" >>failed.22
    fi
fi
