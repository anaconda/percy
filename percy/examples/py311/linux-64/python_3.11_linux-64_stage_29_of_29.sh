...
if [[ ! -f apache-airflow-providers-common-sql-feedstock.mark ]]; then
    if [[ -d apache-airflow-providers-common-sql-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-airflow-providers-common-sql-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-airflow-providers-common-sql-feedstock.mark ) && true) || ( (echo "apache-airflow-providers-common-sql-feedstock" >>failed.29 ) && (echo "apache-airflow-providers-common-sql-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-airflow-providers-common-sql-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f apache-airflow-providers-http-feedstock.mark ]]; then
    if [[ -d apache-airflow-providers-http-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-airflow-providers-http-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-airflow-providers-http-feedstock.mark ) && true) || ( (echo "apache-airflow-providers-http-feedstock" >>failed.29 ) && (echo "apache-airflow-providers-http-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-airflow-providers-http-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f apache-airflow-providers-imap-feedstock.mark ]]; then
    if [[ -d apache-airflow-providers-imap-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-airflow-providers-imap-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-airflow-providers-imap-feedstock.mark ) && true) || ( (echo "apache-airflow-providers-imap-feedstock" >>failed.29 ) && (echo "apache-airflow-providers-imap-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-airflow-providers-imap-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f apache-libcloud-feedstock.mark ]]; then
    if [[ -d apache-libcloud-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apache-libcloud-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apache-libcloud-feedstock.mark ) && true) || ( (echo "apache-libcloud-feedstock" >>failed.29 ) && (echo "apache-libcloud-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apache-libcloud-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f backports.shutil_which-feedstock.mark ]]; then
    if [[ -d backports.shutil_which-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./backports.shutil_which-feedstock >d 2>&1 && rm -f d && ( echo "done" >>backports.shutil_which-feedstock.mark ) && true) || ( (echo "backports.shutil_which-feedstock" >>failed.29 ) && (echo "backports.shutil_which-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "backports.shutil_which-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f capturer-feedstock.mark ]]; then
    if [[ -d capturer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./capturer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>capturer-feedstock.mark ) && true) || ( (echo "capturer-feedstock" >>failed.29 ) && (echo "capturer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "capturer-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f cattrs-feedstock.mark ]]; then
    if [[ -d cattrs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cattrs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cattrs-feedstock.mark ) && true) || ( (echo "cattrs-feedstock" >>failed.29 ) && (echo "cattrs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cattrs-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f clickhouse-driver-feedstock.mark ]]; then
    if [[ -d clickhouse-driver-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./clickhouse-driver-feedstock >d 2>&1 && rm -f d && ( echo "done" >>clickhouse-driver-feedstock.mark ) && true) || ( (echo "clickhouse-driver-feedstock" >>failed.29 ) && (echo "clickhouse-driver-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "clickhouse-driver-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f coloredlogs-feedstock.mark ]]; then
    if [[ -d coloredlogs-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./coloredlogs-feedstock >d 2>&1 && rm -f d && ( echo "done" >>coloredlogs-feedstock.mark ) && true) || ( (echo "coloredlogs-feedstock" >>failed.29 ) && (echo "coloredlogs-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "coloredlogs-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f colorlog-feedstock.mark ]]; then
    if [[ -d colorlog-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./colorlog-feedstock >d 2>&1 && rm -f d && ( echo "done" >>colorlog-feedstock.mark ) && true) || ( (echo "colorlog-feedstock" >>failed.29 ) && (echo "colorlog-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "colorlog-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f configspace-feedstock.mark ]]; then
    if [[ -d configspace-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./configspace-feedstock >d 2>&1 && rm -f d && ( echo "done" >>configspace-feedstock.mark ) && true) || ( (echo "configspace-feedstock" >>failed.29 ) && (echo "configspace-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "configspace-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f configupdater-feedstock.mark ]]; then
    if [[ -d configupdater-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./configupdater-feedstock >d 2>&1 && rm -f d && ( echo "done" >>configupdater-feedstock.mark ) && true) || ( (echo "configupdater-feedstock" >>failed.29 ) && (echo "configupdater-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "configupdater-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f connexion-feedstock.mark ]]; then
    if [[ -d connexion-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./connexion-feedstock >d 2>&1 && rm -f d && ( echo "done" >>connexion-feedstock.mark ) && true) || ( (echo "connexion-feedstock" >>failed.29 ) && (echo "connexion-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "connexion-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f coveralls-feedstock.mark ]]; then
    if [[ -d coveralls-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./coveralls-feedstock >d 2>&1 && rm -f d && ( echo "done" >>coveralls-feedstock.mark ) && true) || ( (echo "coveralls-feedstock" >>failed.29 ) && (echo "coveralls-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "coveralls-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f cron-descriptor-feedstock.mark ]]; then
    if [[ -d cron-descriptor-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./cron-descriptor-feedstock >d 2>&1 && rm -f d && ( echo "done" >>cron-descriptor-feedstock.mark ) && true) || ( (echo "cron-descriptor-feedstock" >>failed.29 ) && (echo "cron-descriptor-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "cron-descriptor-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f croniter-feedstock.mark ]]; then
    if [[ -d croniter-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./croniter-feedstock >d 2>&1 && rm -f d && ( echo "done" >>croniter-feedstock.mark ) && true) || ( (echo "croniter-feedstock" >>failed.29 ) && (echo "croniter-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "croniter-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f dash-bio-feedstock.mark ]]; then
    if [[ -d dash-bio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dash-bio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dash-bio-feedstock.mark ) && true) || ( (echo "dash-bio-feedstock" >>failed.29 ) && (echo "dash-bio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dash-bio-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f dropbox-feedstock.mark ]]; then
    if [[ -d dropbox-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dropbox-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dropbox-feedstock.mark ) && true) || ( (echo "dropbox-feedstock" >>failed.29 ) && (echo "dropbox-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dropbox-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f flask-caching-feedstock.mark ]]; then
    if [[ -d flask-caching-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./flask-caching-feedstock >d 2>&1 && rm -f d && ( echo "done" >>flask-caching-feedstock.mark ) && true) || ( (echo "flask-caching-feedstock" >>failed.29 ) && (echo "flask-caching-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "flask-caching-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f flask-session-feedstock.mark ]]; then
    if [[ -d flask-session-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./flask-session-feedstock >d 2>&1 && rm -f d && ( echo "done" >>flask-session-feedstock.mark ) && true) || ( (echo "flask-session-feedstock" >>failed.29 ) && (echo "flask-session-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "flask-session-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f geoviews-feedstock.mark ]]; then
    if [[ -d geoviews-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./geoviews-feedstock >d 2>&1 && rm -f d && ( echo "done" >>geoviews-feedstock.mark ) && true) || ( (echo "geoviews-feedstock" >>failed.29 ) && (echo "geoviews-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "geoviews-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f gunicorn-feedstock.mark ]]; then
    if [[ -d gunicorn-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./gunicorn-feedstock >d 2>&1 && rm -f d && ( echo "done" >>gunicorn-feedstock.mark ) && true) || ( (echo "gunicorn-feedstock" >>failed.29 ) && (echo "gunicorn-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "gunicorn-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f httpx-feedstock.mark ]]; then
    if [[ -d httpx-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./httpx-feedstock >d 2>&1 && rm -f d && ( echo "done" >>httpx-feedstock.mark ) && true) || ( (echo "httpx-feedstock" >>failed.29 ) && (echo "httpx-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "httpx-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f ibis-framework-feedstock.mark ]]; then
    if [[ -d ibis-framework-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ibis-framework-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ibis-framework-feedstock.mark ) && true) || ( (echo "ibis-framework-feedstock" >>failed.29 ) && (echo "ibis-framework-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ibis-framework-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f ipaddr-feedstock.mark ]]; then
    if [[ -d ipaddr-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./ipaddr-feedstock >d 2>&1 && rm -f d && ( echo "done" >>ipaddr-feedstock.mark ) && true) || ( (echo "ipaddr-feedstock" >>failed.29 ) && (echo "ipaddr-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "ipaddr-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f lancet-feedstock.mark ]]; then
    if [[ -d lancet-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./lancet-feedstock >d 2>&1 && rm -f d && ( echo "done" >>lancet-feedstock.mark ) && true) || ( (echo "lancet-feedstock" >>failed.29 ) && (echo "lancet-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "lancet-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f linkify-it-py-feedstock.mark ]]; then
    if [[ -d linkify-it-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./linkify-it-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>linkify-it-py-feedstock.mark ) && true) || ( (echo "linkify-it-py-feedstock" >>failed.29 ) && (echo "linkify-it-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "linkify-it-py-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f marshmallow-oneofschema-feedstock.mark ]]; then
    if [[ -d marshmallow-oneofschema-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./marshmallow-oneofschema-feedstock >d 2>&1 && rm -f d && ( echo "done" >>marshmallow-oneofschema-feedstock.mark ) && true) || ( (echo "marshmallow-oneofschema-feedstock" >>failed.29 ) && (echo "marshmallow-oneofschema-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "marshmallow-oneofschema-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f mdit-py-plugins-feedstock.mark ]]; then
    if [[ -d mdit-py-plugins-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./mdit-py-plugins-feedstock >d 2>&1 && rm -f d && ( echo "done" >>mdit-py-plugins-feedstock.mark ) && true) || ( (echo "mdit-py-plugins-feedstock" >>failed.29 ) && (echo "mdit-py-plugins-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "mdit-py-plugins-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f nb_anacondacloud-feedstock.mark ]]; then
    if [[ -d nb_anacondacloud-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_anacondacloud-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_anacondacloud-feedstock.mark ) && true) || ( (echo "nb_anacondacloud-feedstock" >>failed.29 ) && (echo "nb_anacondacloud-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_anacondacloud-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f nbserverproxy-feedstock.mark ]]; then
    if [[ -d nbserverproxy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nbserverproxy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nbserverproxy-feedstock.mark ) && true) || ( (echo "nbserverproxy-feedstock" >>failed.29 ) && (echo "nbserverproxy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nbserverproxy-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f netifaces-feedstock.mark ]]; then
    if [[ -d netifaces-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./netifaces-feedstock >d 2>&1 && rm -f d && ( echo "done" >>netifaces-feedstock.mark ) && true) || ( (echo "netifaces-feedstock" >>failed.29 ) && (echo "netifaces-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "netifaces-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f pyinstaller-feedstock.mark ]]; then
    if [[ -d pyinstaller-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyinstaller-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyinstaller-feedstock.mark ) && true) || ( (echo "pyinstaller-feedstock" >>failed.29 ) && (echo "pyinstaller-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyinstaller-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f python-lmdb-feedstock.mark ]]; then
    if [[ -d python-lmdb-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-lmdb-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-lmdb-feedstock.mark ) && true) || ( (echo "python-lmdb-feedstock" >>failed.29 ) && (echo "python-lmdb-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-lmdb-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f python-memcached-feedstock.mark ]]; then
    if [[ -d python-memcached-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-memcached-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-memcached-feedstock.mark ) && true) || ( (echo "python-memcached-feedstock" >>failed.29 ) && (echo "python-memcached-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-memcached-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f python-utils-feedstock.mark ]]; then
    if [[ -d python-utils-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-utils-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-utils-feedstock.mark ) && true) || ( (echo "python-utils-feedstock" >>failed.29 ) && (echo "python-utils-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-utils-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f requests_download-feedstock.mark ]]; then
    if [[ -d requests_download-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./requests_download-feedstock >d 2>&1 && rm -f d && ( echo "done" >>requests_download-feedstock.mark ) && true) || ( (echo "requests_download-feedstock" >>failed.29 ) && (echo "requests_download-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "requests_download-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f scikit-learn-intelex-feedstock.mark ]]; then
    if [[ -d scikit-learn-intelex-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-learn-intelex-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-learn-intelex-feedstock.mark ) && true) || ( (echo "scikit-learn-intelex-feedstock" >>failed.29 ) && (echo "scikit-learn-intelex-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-learn-intelex-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f setproctitle-feedstock.mark ]]; then
    if [[ -d setproctitle-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./setproctitle-feedstock >d 2>&1 && rm -f d && ( echo "done" >>setproctitle-feedstock.mark ) && true) || ( (echo "setproctitle-feedstock" >>failed.29 ) && (echo "setproctitle-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "setproctitle-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f slackclient-feedstock.mark ]]; then
    if [[ -d slackclient-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./slackclient-feedstock >d 2>&1 && rm -f d && ( echo "done" >>slackclient-feedstock.mark ) && true) || ( (echo "slackclient-feedstock" >>failed.29 ) && (echo "slackclient-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "slackclient-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f snakebite-py3-feedstock.mark ]]; then
    if [[ -d snakebite-py3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./snakebite-py3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>snakebite-py3-feedstock.mark ) && true) || ( (echo "snakebite-py3-feedstock" >>failed.29 ) && (echo "snakebite-py3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "snakebite-py3-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f sputnik-feedstock.mark ]]; then
    if [[ -d sputnik-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sputnik-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sputnik-feedstock.mark ) && true) || ( (echo "sputnik-feedstock" >>failed.29 ) && (echo "sputnik-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sputnik-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f swagger-ui-bundle-feedstock.mark ]]; then
    if [[ -d swagger-ui-bundle-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./swagger-ui-bundle-feedstock >d 2>&1 && rm -f d && ( echo "done" >>swagger-ui-bundle-feedstock.mark ) && true) || ( (echo "swagger-ui-bundle-feedstock" >>failed.29 ) && (echo "swagger-ui-bundle-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "swagger-ui-bundle-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f tabulate-feedstock.mark ]]; then
    if [[ -d tabulate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./tabulate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>tabulate-feedstock.mark ) && true) || ( (echo "tabulate-feedstock" >>failed.29 ) && (echo "tabulate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "tabulate-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f termcolor-feedstock.mark ]]; then
    if [[ -d termcolor-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./termcolor-feedstock >d 2>&1 && rm -f d && ( echo "done" >>termcolor-feedstock.mark ) && true) || ( (echo "termcolor-feedstock" >>failed.29 ) && (echo "termcolor-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "termcolor-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f twython-feedstock.mark ]]; then
    if [[ -d twython-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./twython-feedstock/ >d 2>&1 && rm -f d && ( echo "done" >>twython-feedstock.mark ) && true) || ( (echo "twython-feedstock" >>failed.29 ) && (echo "twython-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "twython-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f typing-feedstock.mark ]]; then
    if [[ -d typing-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./typing-feedstock >d 2>&1 && rm -f d && ( echo "done" >>typing-feedstock.mark ) && true) || ( (echo "typing-feedstock" >>failed.29 ) && (echo "typing-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "typing-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f unicodecsv-feedstock.mark ]]; then
    if [[ -d unicodecsv-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./unicodecsv-feedstock >d 2>&1 && rm -f d && ( echo "done" >>unicodecsv-feedstock.mark ) && true) || ( (echo "unicodecsv-feedstock" >>failed.29 ) && (echo "unicodecsv-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "unicodecsv-feedstock not present" >>failed.29
    fi
fi
