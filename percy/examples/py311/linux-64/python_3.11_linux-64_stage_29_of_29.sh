...
if [[ ! -f odo-feedstock.mark ]]; then
    if [[ -d odo-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./odo-feedstock >d 2>&1 && rm -f d && ( echo "done" >>odo-feedstock.mark ) && true) || ( (echo "odo-feedstock" >>failed.29 ) && (echo "odo-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "odo-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f quilt3-feedstock.mark ]]; then
    if [[ -d quilt3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./quilt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>quilt3-feedstock.mark ) && true) || ( (echo "quilt3-feedstock" >>failed.29 ) && (echo "quilt3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "quilt3-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f runipy-feedstock.mark ]]; then
    if [[ -d runipy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./runipy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>runipy-feedstock.mark ) && true) || ( (echo "runipy-feedstock" >>failed.29 ) && (echo "runipy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "runipy-feedstock not present" >>failed.29
    fi
fi
...
if [[ ! -f scikit-bio-feedstock.mark ]]; then
    if [[ -d scikit-bio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-bio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-bio-feedstock.mark ) && true) || ( (echo "scikit-bio-feedstock" >>failed.29 ) && (echo "scikit-bio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-bio-feedstock not present" >>failed.29
    fi
fi
