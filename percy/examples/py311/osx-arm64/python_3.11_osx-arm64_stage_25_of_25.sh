...
if [[ ! -f atom-feedstock.mark ]]; then
    if [[ -d atom-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./atom-feedstock >d 2>&1 && rm -f d && ( echo "done" >>atom-feedstock.mark ) && true) || ( (echo "atom-feedstock" >>failed.25 ) && (echo "atom-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "atom-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f nb_conda_kernels-feedstock.mark ]]; then
    if [[ -d nb_conda_kernels-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_conda_kernels-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_conda_kernels-feedstock.mark ) && true) || ( (echo "nb_conda_kernels-feedstock" >>failed.25 ) && (echo "nb_conda_kernels-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_conda_kernels-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pycares-feedstock.mark ]]; then
    if [[ -d pycares-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pycares-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pycares-feedstock.mark ) && true) || ( (echo "pycares-feedstock" >>failed.25 ) && (echo "pycares-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pycares-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f python-chromedriver-binary-feedstock.mark ]]; then
    if [[ -d python-chromedriver-binary-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-chromedriver-binary-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-chromedriver-binary-feedstock.mark ) && true) || ( (echo "python-chromedriver-binary-feedstock" >>failed.25 ) && (echo "python-chromedriver-binary-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-chromedriver-binary-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f salt-feedstock.mark ]]; then
    if [[ -d salt-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./salt-feedstock >d 2>&1 && rm -f d && ( echo "done" >>salt-feedstock.mark ) && true) || ( (echo "salt-feedstock" >>failed.25 ) && (echo "salt-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "salt-feedstock not present" >>failed.25
    fi
fi
