...
if [[ ! -f accelerate-feedstock.mark ]]; then
    if [[ -d accelerate-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./accelerate-feedstock >d 2>&1 && rm -f d && ( echo "done" >>accelerate-feedstock.mark ) && true) || ( (echo "accelerate-feedstock" >>failed.28 ) && (echo "accelerate-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "accelerate-feedstock not present" >>failed.28
    fi
fi
...
if [[ ! -f grpcio-tools-feedstock.mark ]]; then
    if [[ -d grpcio-tools-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./grpcio-tools-feedstock >d 2>&1 && rm -f d && ( echo "done" >>grpcio-tools-feedstock.mark ) && true) || ( (echo "grpcio-tools-feedstock" >>failed.28 ) && (echo "grpcio-tools-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "grpcio-tools-feedstock not present" >>failed.28
    fi
fi
...
if [[ ! -f hdfs3-feedstock.mark ]]; then
    if [[ -d hdfs3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./hdfs3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>hdfs3-feedstock.mark ) && true) || ( (echo "hdfs3-feedstock" >>failed.28 ) && (echo "hdfs3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "hdfs3-feedstock not present" >>failed.28
    fi
fi
...
if [[ ! -f knit-feedstock.mark ]]; then
    if [[ -d knit-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./knit-feedstock >d 2>&1 && rm -f d && ( echo "done" >>knit-feedstock.mark ) && true) || ( (echo "knit-feedstock" >>failed.28 ) && (echo "knit-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "knit-feedstock not present" >>failed.28
    fi
fi
...
if [[ ! -f macholib-feedstock.mark ]]; then
    if [[ -d macholib-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./macholib-feedstock >d 2>&1 && rm -f d && ( echo "done" >>macholib-feedstock.mark ) && true) || ( (echo "macholib-feedstock" >>failed.28 ) && (echo "macholib-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "macholib-feedstock not present" >>failed.28
    fi
fi
...
if [[ ! -f whatthepatch-feedstock.mark ]]; then
    if [[ -d whatthepatch-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./whatthepatch-feedstock >d 2>&1 && rm -f d && ( echo "done" >>whatthepatch-feedstock.mark ) && true) || ( (echo "whatthepatch-feedstock" >>failed.28 ) && (echo "whatthepatch-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "whatthepatch-feedstock not present" >>failed.28
    fi
fi
