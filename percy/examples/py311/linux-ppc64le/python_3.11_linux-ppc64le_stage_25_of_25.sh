...
if [[ ! -f absl-py-feedstock.mark ]]; then
    if [[ -d absl-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./absl-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>absl-py-feedstock.mark ) && true) || ( (echo "absl-py-feedstock" >>failed.25 ) && (echo "absl-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "absl-py-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f astropy-feedstock.mark ]]; then
    if [[ -d astropy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./astropy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>astropy-feedstock.mark ) && true) || ( (echo "astropy-feedstock" >>failed.25 ) && (echo "astropy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "astropy-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f autovizwidget-feedstock.mark ]]; then
    if [[ -d autovizwidget-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./autovizwidget-feedstock >d 2>&1 && rm -f d && ( echo "done" >>autovizwidget-feedstock.mark ) && true) || ( (echo "autovizwidget-feedstock" >>failed.25 ) && (echo "autovizwidget-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "autovizwidget-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f dbus-python-feedstock.mark ]]; then
    if [[ -d dbus-python-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./dbus-python-feedstock >d 2>&1 && rm -f d && ( echo "done" >>dbus-python-feedstock.mark ) && true) || ( (echo "dbus-python-feedstock" >>failed.25 ) && (echo "dbus-python-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "dbus-python-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f jellyfish-feedstock.mark ]]; then
    if [[ -d jellyfish-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./jellyfish-feedstock >d 2>&1 && rm -f d && ( echo "done" >>jellyfish-feedstock.mark ) && true) || ( (echo "jellyfish-feedstock" >>failed.25 ) && (echo "jellyfish-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "jellyfish-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f numpydoc-feedstock.mark ]]; then
    if [[ -d numpydoc-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./numpydoc-feedstock >d 2>&1 && rm -f d && ( echo "done" >>numpydoc-feedstock.mark ) && true) || ( (echo "numpydoc-feedstock" >>failed.25 ) && (echo "numpydoc-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "numpydoc-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pyopengl-feedstock.mark ]]; then
    if [[ -d pyopengl-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyopengl-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyopengl-feedstock.mark ) && true) || ( (echo "pyopengl-feedstock" >>failed.25 ) && (echo "pyopengl-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyopengl-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f pyqt-builder-feedstock.mark ]]; then
    if [[ -d pyqt-builder-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyqt-builder-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyqt-builder-feedstock.mark ) && true) || ( (echo "pyqt-builder-feedstock" >>failed.25 ) && (echo "pyqt-builder-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyqt-builder-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f python-lsp-black-feedstock.mark ]]; then
    if [[ -d python-lsp-black-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-lsp-black-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-lsp-black-feedstock.mark ) && true) || ( (echo "python-lsp-black-feedstock" >>failed.25 ) && (echo "python-lsp-black-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-lsp-black-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f qtstylizer-feedstock.mark ]]; then
    if [[ -d qtstylizer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qstylizer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qtstylizer-feedstock.mark ) && true) || ( (echo "qtstylizer-feedstock" >>failed.25 ) && (echo "qtstylizer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qtstylizer-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f rtree-feedstock.mark ]]; then
    if [[ -d rtree-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./rtree-feedstock >d 2>&1 && rm -f d && ( echo "done" >>rtree-feedstock.mark ) && true) || ( (echo "rtree-feedstock" >>failed.25 ) && (echo "rtree-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "rtree-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f sas_kernel-feedstock.mark ]]; then
    if [[ -d sas_kernel-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sas_kernel-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sas_kernel-feedstock.mark ) && true) || ( (echo "sas_kernel-feedstock" >>failed.25 ) && (echo "sas_kernel-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sas_kernel-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f scikit-image-feedstock.mark ]]; then
    if [[ -d scikit-image-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./scikit-image-feedstock >d 2>&1 && rm -f d && ( echo "done" >>scikit-image-feedstock.mark ) && true) || ( (echo "scikit-image-feedstock" >>failed.25 ) && (echo "scikit-image-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "scikit-image-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f spyder-kernels-feedstock.mark ]]; then
    if [[ -d spyder-kernels-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./spyder-kernels-feedstock >d 2>&1 && rm -f d && ( echo "done" >>spyder-kernels-feedstock.mark ) && true) || ( (echo "spyder-kernels-feedstock" >>failed.25 ) && (echo "spyder-kernels-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "spyder-kernels-feedstock not present" >>failed.25
    fi
fi
...
if [[ ! -f vispy-feedstock.mark ]]; then
    if [[ -d vispy-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./vispy-feedstock >d 2>&1 && rm -f d && ( echo "done" >>vispy-feedstock.mark ) && true) || ( (echo "vispy-feedstock" >>failed.25 ) && (echo "vispy-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "vispy-feedstock not present" >>failed.25
    fi
fi
