...
if [[ ! -f altgraph-feedstock.mark ]]; then
    if [[ -d altgraph-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./altgraph-feedstock >d 2>&1 && rm -f d && ( echo "done" >>altgraph-feedstock.mark ) && true) || ( (echo "altgraph-feedstock" >>failed.24 ) && (echo "altgraph-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "altgraph-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f apispec-feedstock.mark ]]; then
    if [[ -d apispec-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./apispec-feedstock >d 2>&1 && rm -f d && ( echo "done" >>apispec-feedstock.mark ) && true) || ( (echo "apispec-feedstock" >>failed.24 ) && (echo "apispec-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "apispec-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f gdb-feedstock.mark ]]; then
    if [[ -d gdb-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./gdb-feedstock >d 2>&1 && rm -f d && ( echo "done" >>gdb-feedstock.mark ) && true) || ( (echo "gdb-feedstock" >>failed.24 ) && (echo "gdb-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "gdb-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f hdijupyterutils-feedstock.mark ]]; then
    if [[ -d hdijupyterutils-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./hdijupyterutils-feedstock >d 2>&1 && rm -f d && ( echo "done" >>hdijupyterutils-feedstock.mark ) && true) || ( (echo "hdijupyterutils-feedstock" >>failed.24 ) && (echo "hdijupyterutils-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "hdijupyterutils-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f imageio-feedstock.mark ]]; then
    if [[ -d imageio-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./imageio-feedstock >d 2>&1 && rm -f d && ( echo "done" >>imageio-feedstock.mark ) && true) || ( (echo "imageio-feedstock" >>failed.24 ) && (echo "imageio-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "imageio-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f inflection-feedstock.mark ]]; then
    if [[ -d inflection-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./inflection-feedstock >d 2>&1 && rm -f d && ( echo "done" >>inflection-feedstock.mark ) && true) || ( (echo "inflection-feedstock" >>failed.24 ) && (echo "inflection-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "inflection-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f maturin-feedstock.mark ]]; then
    if [[ -d maturin-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./maturin-feedstock >d 2>&1 && rm -f d && ( echo "done" >>maturin-feedstock.mark ) && true) || ( (echo "maturin-feedstock" >>failed.24 ) && (echo "maturin-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "maturin-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f plotly-feedstock.mark ]]; then
    if [[ -d plotly-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./plotly-feedstock >d 2>&1 && rm -f d && ( echo "done" >>plotly-feedstock.mark ) && true) || ( (echo "plotly-feedstock" >>failed.24 ) && (echo "plotly-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "plotly-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyerfa-feedstock.mark ]]; then
    if [[ -d pyerfa-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyerfa-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyerfa-feedstock.mark ) && true) || ( (echo "pyerfa-feedstock" >>failed.24 ) && (echo "pyerfa-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyerfa-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f pyinotify-feedstock.mark ]]; then
    if [[ -d pyinotify-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./pyinotify-feedstock >d 2>&1 && rm -f d && ( echo "done" >>pyinotify-feedstock.mark ) && true) || ( (echo "pyinotify-feedstock" >>failed.24 ) && (echo "pyinotify-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "pyinotify-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f python-lsp-server-feedstock.mark ]]; then
    if [[ -d python-lsp-server-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./python-lsp-server-feedstock >d 2>&1 && rm -f d && ( echo "done" >>python-lsp-server-feedstock.mark ) && true) || ( (echo "python-lsp-server-feedstock" >>failed.24 ) && (echo "python-lsp-server-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "python-lsp-server-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sip-feedstock.mark ]]; then
    if [[ -d sip-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sip-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sip-feedstock.mark ) && true) || ( (echo "sip-feedstock" >>failed.24 ) && (echo "sip-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sip-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sphinx-feedstock.mark ]]; then
    if [[ -d sphinx-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sphinx-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sphinx-feedstock.mark ) && true) || ( (echo "sphinx-feedstock" >>failed.24 ) && (echo "sphinx-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sphinx-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f wurlitzer-feedstock.mark ]]; then
    if [[ -d wurlitzer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./wurlitzer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>wurlitzer-feedstock.mark ) && true) || ( (echo "wurlitzer-feedstock" >>failed.24 ) && (echo "wurlitzer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "wurlitzer-feedstock not present" >>failed.24
    fi
fi
