...
if [[ ! -f absl-py-feedstock.mark ]]; then
    if [[ -d absl-py-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./absl-py-feedstock >d 2>&1 && rm -f d && ( echo "done" >>absl-py-feedstock.mark ) && true) || ( (echo "absl-py-feedstock" >>failed.24 ) && (echo "absl-py-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "absl-py-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f datashape-feedstock.mark ]]; then
    if [[ -d datashape-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./datashape-feedstock >d 2>&1 && rm -f d && ( echo "done" >>datashape-feedstock.mark ) && true) || ( (echo "datashape-feedstock" >>failed.24 ) && (echo "datashape-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "datashape-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f fast-histogram-feedstock.mark ]]; then
    if [[ -d fast-histogram-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./fast-histogram-feedstock/ >d 2>&1 && rm -f d && ( echo "done" >>fast-histogram-feedstock.mark ) && true) || ( (echo "fast-histogram-feedstock" >>failed.24 ) && (echo "fast-histogram-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "fast-histogram-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f hdfs3-feedstock.mark ]]; then
    if [[ -d hdfs3-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./hdfs3-feedstock >d 2>&1 && rm -f d && ( echo "done" >>hdfs3-feedstock.mark ) && true) || ( (echo "hdfs3-feedstock" >>failed.24 ) && (echo "hdfs3-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "hdfs3-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f nb_conda_kernels-feedstock.mark ]]; then
    if [[ -d nb_conda_kernels-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./nb_conda_kernels-feedstock >d 2>&1 && rm -f d && ( echo "done" >>nb_conda_kernels-feedstock.mark ) && true) || ( (echo "nb_conda_kernels-feedstock" >>failed.24 ) && (echo "nb_conda_kernels-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "nb_conda_kernels-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f qstylizer-feedstock.mark ]]; then
    if [[ -d qstylizer-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./qstylizer-feedstock >d 2>&1 && rm -f d && ( echo "done" >>qstylizer-feedstock.mark ) && true) || ( (echo "qstylizer-feedstock" >>failed.24 ) && (echo "qstylizer-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "qstylizer-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f sas_kernel-feedstock.mark ]]; then
    if [[ -d sas_kernel-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./sas_kernel-feedstock >d 2>&1 && rm -f d && ( echo "done" >>sas_kernel-feedstock.mark ) && true) || ( (echo "sas_kernel-feedstock" >>failed.24 ) && (echo "sas_kernel-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "sas_kernel-feedstock not present" >>failed.24
    fi
fi
...
if [[ ! -f uvicorn-feedstock.mark ]]; then
    if [[ -d uvicorn-feedstock ]]; then
        (conda-build --python=3.11 --numpy=1.22 --croot=../ci_py311/ -c py311_bs/label/release --use-local --no-test ./uvicorn-feedstock >d 2>&1 && rm -f d && ( echo "done" >>uvicorn-feedstock.mark ) && true) || ( (echo "uvicorn-feedstock" >>failed.24 ) && (echo "uvicorn-feedstock" >>errors.dump ) && ( cat d >>errors.dump ) && cat d && rm -f d && true) || true
    else
        echo "uvicorn-feedstock not present" >>failed.24
    fi
fi
