...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./urllib3-feedstock || echo "urllib3-feedstock" >>failed.19 || cmd /K "exit /b 0"
