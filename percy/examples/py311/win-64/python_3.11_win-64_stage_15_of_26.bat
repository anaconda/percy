...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./gobject-introspection-feedstock || echo "gobject-introspection-feedstock" >>failed.15 || cmd /K "exit /b 0"
