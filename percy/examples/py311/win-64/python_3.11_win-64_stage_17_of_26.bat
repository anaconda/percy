...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./anyio-feedstock || echo "anyio-feedstock" >>failed.17 || cmd /K "exit /b 0"
...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./jupyter-packaging-feedstock || echo "jupyter-packaging-feedstock" >>failed.17 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./matplotlib-inline-feedstock || echo "matplotlib-inline-feedstock" >>failed.17 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./nbconvert-feedstock || echo "nbconvert-feedstock" >>failed.17 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./prometheus_client-feedstock || echo "prometheus_client-feedstock" >>failed.17 || cmd /K "exit /b 0"
