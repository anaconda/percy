...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./distlib-feedstock || echo "distlib-feedstock" >>failed.20 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./filelock-feedstock || echo "filelock-feedstock" >>failed.20 || cmd /K "exit /b 0"
...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./msgpack-python-feedstock || echo "msgpack-python-feedstock" >>failed.20 || cmd /K "exit /b 0"
...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./requests-feedstock || echo "requests-feedstock" >>failed.20 || cmd /K "exit /b 0"
