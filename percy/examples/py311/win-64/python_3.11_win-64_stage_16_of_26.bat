...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./argon2-cffi-bindings-feedstock || echo "argon2-cffi-bindings-feedstock" >>failed.16 || cmd /K "exit /b 0"
...
conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./lxml-feedstock || echo "lxml-feedstock" >>failed.16 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./mistune-feedstock || echo "mistune-feedstock" >>failed.16 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./mistune-0.8.4-feedstock || echo "mistune-0.8.4-feedstock" >>failed.16 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./nbclient-feedstock || echo "nbclient-feedstock" >>failed.16 || cmd /K "exit /b 0"

conda-build --python=3.11 --numpy=1.22 --croot=c:/ci_311/ -c py311_bs/label/release --use-local --no-test ./pandocfilters-feedstock || echo "pandocfilters-feedstock" >>failed.16 || cmd /K "exit /b 0"
